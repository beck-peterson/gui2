...
var generalDogInfo = new GeneralDogInfo("Havanese", "Black and White", "Bicolor", "14 inches", "20 lbs");
var healthInfo = new HealthInfo("Hip displasia", "None", "All up to date");
var breedingInfo = new BreedingInfo();
var sellingInfo = new SellingInfo();
var dogInfo = new Map();
dogInfo.set(generalDogInfo.title, generalDogInfo);
